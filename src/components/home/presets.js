...
const Presets = () => {
    ...
    return (
        ...
        <div className="col-2">
            <button className="preset-button btn btn-success w-100 p-0 m-0"
            onClick={() => {
        ...
        <div className="col-2">
        <button className="preset-button btn btn-info w-100 p-0 m-0"
        onClick={() => {
        ...
        <div className="col-2">
        <button className="preset-button btn btn-danger w-100 p-0 m-0"
        onClick={() => {
        ...
        <div className="col-2">
        <button className="preset-button btn btn-warning w-100 p-0 m-0"
        onClick={() => {
        ...
        <div className="col-2">
        <button className="preset-button btn btn-secondary w-100 p-0 m-0"
        onClick={() => {
