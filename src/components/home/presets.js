...
const Presets = () => {
    ...
    return (
        ...
        <div className="col-2">
            <button className="btn btn-success w-100 p-0 m-0"
            onClick={() => {
        ...
        <div className="col-2">
        <button className="btn btn-info w-100 p-0 m-0"
        onClick={() => {
        ...
        <div className="col-2">
        <button className="btn btn-danger w-100 p-0 m-0"
        onClick={() => {
        ...
        <div className="col-2">
        <button className="btn btn-warning w-100 p-0 m-0"
        onClick={() => {
        ...
        <div className="col-2">
        <button className="btn btn-secondary w-100 p-0 m-0"
        onClick={() => {
