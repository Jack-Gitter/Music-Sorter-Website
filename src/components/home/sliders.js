...
const Sliders = () => {
    ...
    return (
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-0 p-0"> 
                <div className="row text-center">
                    <label className="form-label" for="acousticness-range">
                        ...
                        {sliderEnabled.acousticness && <button className={'btn  ms-2'} onClick={() => dispatcher(updateSliderEnabled({...sliderEnabled, acousticness: false}))}>Disable</button>}
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-0 p-0">
            ...
            {sliderEnabled.danceability && <button className={'btn  ms-2'} onClick={() => dispatcher(updateSliderEnabled({...sliderEnabled, danceability: false}))}>Disable</button>}
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-0 p-0 ">
            ...
            {sliderEnabled.duration_ms && <button className={'btn  ms-2'} onClick={() => dispatcher(updateSliderEnabled({...sliderEnabled, duration_ms: false}))}>Disable</button>}
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-0 p-0">
            ...
            {sliderEnabled.energy && <button className={'btn  ms-2'} onClick={() => dispatcher(updateSliderEnabled({...sliderEnabled, energy: false}))}>Disable</button>}
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-0 p-0">
            ...
            {sliderEnabled.instrumentalness && <button className={'btn  ms-2'} onClick={() => dispatcher(updateSliderEnabled({...sliderEnabled, instrumentalness: false}))}>Disable</button>}
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-0 p-0">
            ...
            {sliderEnabled.liveness && <button className={'btn  ms-2'} onClick={() => dispatcher(updateSliderEnabled({...sliderEnabled, liveness: false}))}>Disable</button>}
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-0 p-0">
            ...
            { sliderEnabled.loudness && <button className={'btn  ms-2'} onClick={() => dispatcher(updateSliderEnabled({...sliderEnabled, loudness: false}))}>Disable</button>}
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-0 p-0">
            ...
            {sliderEnabled.speechiness && <button className={'btn  ms-2'} onClick={() => dispatcher(updateSliderEnabled({...sliderEnabled, speechiness: false}))}>Disable</button>}
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-0 p-0 justify-content-center ">
            ...
            {sliderEnabled.tempo && <button className={'btn  ms-2'} onClick={() => dispatcher(updateSliderEnabled({...sliderEnabled, tempo: false}))}>Disable</button>}
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-0 p-0  justify-content-center ">
           ...
           <label for="valence-range">
            ...
            {sliderEnabled.valence && <button className={'btn  ms-2'} onClick={() => dispatcher(updateSliderEnabled({...sliderEnabled, valence: false}))}>Disable</button>}
            ...
            <button className={'btn  br-0 ms-2 mt-2 me-2'} disabled={loadingMetrics || loadingSongs || currentPlaylist == -1} onClick={() => { 
