...
const Sliders = () => {
    ...
    return (
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-2 p-2 bg-dark.bg-gradient "> 
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-2 p-2 bg-dark.bg-gradient  justify-content-center ">
            <div className="row text-center">
            <span class="form-check form-switch">
