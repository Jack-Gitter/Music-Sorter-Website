            ...
            <div className="row text-center">
                <label for="danceability-range">
                    ...
                    <span class="form-check form-switch">
                        <input onClick={dispatcher(updateSliderEnabled({...sliderEnabled, danceability: !danceability}))}  class="form-check-input" type="checkbox" role="switch" checked={sliderEnabled.danceability}/>
                    </span>
