...
const Sliders = () => {
    ...
    return (
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-1 p-1"> 
                ...
                <div className="row">
                    <input id="acousticness-range" className="form-range p-2" disabled={!acousticnessEnabled} onChange={(e) => acousticnessUpdater(e.target.value)} type='range' min='0' max='100' value={acousticness}></input>
                </div>
        </div>
        <div className="col-sm-6 col-md-4 col-lg-3 m-1 p-1">
            <div className="row">
            ...
            <div className="row">
                <input id="danceability-range" className="form-range p-2 " disabled={!danceabilityEnabled} onChange={(e) => danceabilityUpdater(e.target.value)} type='range' min='0' max='100' value={danceability}></input>
            </div>
        </div>
        <div className="col-sm-6 col-md-4 col-lg-3 m-1 p-1 ">
            <div className="row">
            ...
            <div className="row">
                <input id="duration-range" className="form-range p-2 " disabled={!durationEnabled}onChange={(e) => durationUpdater(e.target.value)} type='range' min='0' max='100' value={duration_ms}></input>
            </div>
        </div>
        <div className="col-sm-6 col-md-4 col-lg-3 m-1 p-1">
            <div className="row">
            ...
            <div className="row">
                <input id="energy-range" className="form-range p-2 d-block"disabled={!energyEnabled} onChange={(e) => energyUpdater(e.target.value)} type='range' min='0' max='100' value={energy}></input>
            </div>
        </div>
        <div className="col-sm-6 col-md-4 col-lg-3 m-1 p-1">
            <div className="row">
            ...
            <div className="row">
                <input id="instrumental-range" className="form-range p-2 " disabled={!instrumentalnessEnabled} onChange={(e) => instrumentalnessUpdater(e.target.value)} type='range' min='0' max='100' value={instrumentalness}></input>
            </div>
        </div>
        <div className="col-sm-6 col-md-4 col-lg-3 m-1 p-1">
            <div className="row">
            ...
            <div className="row">
                <input  id="liveness-range" className="form-range p-2 " disabled={!livenessEnabled} onChange={(e) => livenessUpdater(e.target.value)} type='range' min='0' max='100' value={liveness}></input>
            </div>
        </div>
        <div className="col-sm-6 col-md-4 col-lg-3 m-1 p-1">
            <div className="row">
            ...
            <div className="row">
                <input id="loudness-range" className="form-range p-2 " disabled={!loudnessEnabled} onChange={(e) => loudnessUpdater(e.target.value)} type='range' min='0' max='100' value={loudness}></input>
            </div>
        </div>
        <div className="col-sm-6 col-md-4 col-lg-3 m-1 p-1">
            <div className="row">
            ...
            <div className="row">
                <input id="speechiness-range" className="form-range p-2 " disabled={!speechinessEnabled} onChange={(e) => speechinessUpdater(e.target.value)} type='range' min='0' max='100' value={speechiness}></input>
            </div>
        </div>
        <div className="col-sm-6 col-md-4 col-lg-3 m-1 p-1 justify-content-center ">
            ...
            <div className="row">
                <input  id="tempo-range" className="form-range p-2 " disabled={!tempoEnabled} onChange={(e) => tempoUpdater(e.target.value)} type='range' min='0' max='100' value={tempo}></input>
            </div>
        </div>
        <div className="col-sm-6 col-md-4 col-lg-3 m-1 p-1  justify-content-center ">
           <div className="row">
           <label for="valence-range">
            ...
            <div className="row">
                <input id="valence-range" className="form-range p-2" disabled={!valenceEnabled} onChange={(e) => valenceUpdater(e.target.value)} type='range' min='0' max='100' value={valence}></input>
            </div>
        </div>
