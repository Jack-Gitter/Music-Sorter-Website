...
const Sliders = () => {
    ...
    return (
        <div className="row align-items-center justify-content-center ms-3 mt-4 mb-4 me-3">
        ...
        <div className="col-sm-6 col-md-4 col-lg-3 m-0 p-0  justify-content-center ">
           ...
           <label for="valence-range">
            ...
            <button className={'btn btn-dark br-0 ms-2 me-2'} disabled={loadingMetrics || loadingSongs || currentPlaylist == -1} onClick={() => { 
