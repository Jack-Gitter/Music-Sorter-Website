...
const Sliders = () => {
    ...
    const [acousticnessEnabled, acousticnessStatus] = useState(sliderEnabled.acousticness)
    const [danceabilityEnabled, danceabilityStatus] = useState(sliderEnabled.danceability)
    const [durationEnabled, durationStatus] = useState(sliderEnabled.duration)
    const [energyEnabled, energyStatus] = useState(sliderEnabled.energy)
    const [instrumentalnessEnabled, instrumentalnessStatus] = useState(sliderEnabled.instrumentalness)
    const [livenessEnabled, livenessStatus] = useState(sliderEnabled.liveness)
    const [speechinessEnabled, speechinessStatus] = useState(sliderEnabled.speechiness)
    const [tempoEnabled, tempoStatus] = useState(sliderEnabled.tempo)
    const [valenceEnabled, valenceStatus] = useState(sliderEnabled.valence)
    const [loudnessEnabled, loudnessStatus] = useState(sliderEnabled.loudness)
