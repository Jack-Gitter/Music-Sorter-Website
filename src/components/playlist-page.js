...
const PlaylistPage = () => {
    ...
    return (
        ...
        <ul className="list-group">
            {songs.slice(firstSongDisplayedIDX-1,firstSongDisplayedIDX+5).map((track) => <li className="text-align-center list-group-item list-group-item-dark">{track.name}</li>)}
        </ul>
        <Sliders/>
        <WebPlayback/>
        </div>
